...
% directory,or else change the data_pathname and save_pathname directory
% locations manually;
...
b18lab_pathname='C:\Users\alexk\OneDrive\Documents\MATLAB\B18-Wearables-Laboratory-main\B18-Wearables-Laboratory-main';
...
options.acc_threshold=0.15*G;  %choose value
options.ssd_threshold=0.3*G;  %choose value
...
%-------------------------------------------------------------------------%
options.MinPeakDistance=0.17;    %choose value
...
%identifier
file_index=10; %choose a value [1, 2, ..., N], where N are the number of files
